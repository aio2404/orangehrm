...
// Password configuration - using custom password for all users
$userPassword = getenv('DEFAULT_USER_PASSWORD') ?: 'SecurePass123!';

// Log password configuration
echo "=== PASSWORD CONFIGURATION ===\n";
echo "User Password: $userPassword\n";
echo "==============================\n";

// Log user password for demo purposes
echo "=== USER PASSWORDS ===\n";
echo "All users password: $userPassword\n";
echo "======================\n";

// User data with custom password for all users
$users[0][0] = "USR002"; $users[0][1] = "Kayla"; $users[0][2] = md5($userPassword);
$users[1][0] = "USR003"; $users[1][1] = "Ashley"; $users[1][2] = md5($userPassword);
$users[2][0] = "USR004"; $users[2][1] = "Tyler"; $users[2][2] = md5($userPassword);
$users[3][0] = "USR005"; $users[3][1] = "Landon"; $users[3][2] = md5($userPassword);
$users[4][0] = "USR006"; $users[4][1] = "James"; $users[4][2] = md5($userPassword);
$users[5][0] = "USR007"; $users[5][1] = "Hailey"; $users[5][2] = md5($userPassword);
$users[6][0] = "USR008"; $users[6][1] = "Jenna"; $users[6][2] = md5($userPassword);
$users[7][0] = "USR009"; $users[7][1] = "Audrey"; $users[7][2] = md5($userPassword);
$users[8][0] = "USR010"; $users[8][1] = "Hayden"; $users[8][2] = md5($userPassword);
$users[9][0] = "USR011"; $users[9][1] = "Lauren"; $users[9][2] = md5($userPassword);
$users[10][0] = "USR012"; $users[10][1] = "Grace"; $users[10][2] = md5($userPassword);
$users[11][0] = "USR013"; $users[11][1] = "Chase"; $users[11][2] = md5($userPassword);
$users[12][0] = "USR014"; $users[12][1] = "Brooklyn"; $users[12][2] = md5($userPassword);
$users[13][0] = "USR015"; $users[13][1] = "Adrian"; $users[13][2] = md5($userPassword);
$users[14][0] = "USR016"; $users[14][1] = "Alexa"; $users[14][2] = md5($userPassword);
$users[15][0] = "USR017"; $users[15][1] = "Anthony"; $users[15][2] = md5($userPassword);
$users[16][0] = "USR018"; $users[16][1] = "William"; $users[16][2] = md5($userPassword);
$users[17][0] = "USR019"; $users[17][1] = "Andrew"; $users[17][2] = md5($userPassword);
$users[18][0] = "USR020"; $users[18][1] = "Benjamin"; $users[18][2] = md5($userPassword);
$users[19][0] = "USR021"; $users[19][1] = "Amanda"; $users[19][2] = md5($userPassword);
$users[20][0] = "USR022"; $users[20][1] = "Lillian"; $users[20][2] = md5($userPassword);
$users[21][0] = "USR023"; $users[21][1] = "Jennifer"; $users[21][2] = md5($userPassword);
$users[22][0] = "USR024"; $users[22][1] = "Carter"; $users[22][2] = md5($userPassword);
$users[23][0] = "USR025"; $users[23][1] = "Kimberly"; $users[23][2] = md5($userPassword);
$users[24][0] = "USR026"; $users[24][1] = "Amelia"; $users[24][2] = md5($userPassword);
$users[25][0] = "USR027"; $users[25][1] = "Mason"; $users[25][2] = md5($userPassword);
$users[26][0] = "USR028"; $users[26][1] = "Taylor"; $users[26][2] = md5($userPassword);
$users[27][0] = "USR029"; $users[27][1] = "Brandon"; $users[27][2] = md5($userPassword);
$users[28][0] = "USR030"; $users[28][1] = "Lucas"; $users[28][2] = md5($userPassword);
$users[29][0] = "USR031"; $users[29][1] = "Dominic"; $users[29][2] = md5($userPassword);
$users[30][0] = "USR032"; $users[30][1] = "Justin"; $users[30][2] = md5($userPassword);
$users[31][0] = "USR033"; $users[31][1] = "Steven"; $users[31][2] = md5($userPassword);
$users[32][0] = "USR034"; $users[32][1] = "Austin"; $users[32][2] = md5($userPassword);
$users[33][0] = "USR035"; $users[33][1] = "Marie"; $users[33][2] = md5($userPassword);
$users[34][0] = "USR036"; $users[34][1] = "Robert"; $users[34][2] = md5($userPassword);
$users[35][0] = "USR037"; $users[35][1] = "Laura"; $users[35][2] = md5($userPassword);
$users[36][0] = "USR038"; $users[36][1] = "Carson"; $users[36][2] = md5($userPassword);
$users[37][0] = "USR039"; $users[37][1] = "Timothy"; $users[37][2] = md5($userPassword);
$users[38][0] = "USR040"; $users[38][1] = "Allison"; $users[38][2] = md5($userPassword);
$users[39][0] = "USR041"; $users[39][1] = "Isabelle"; $users[39][2] = md5($userPassword);
$users[40][0] = "USR042"; $users[40][1] = "Katie"; $users[40][2] = md5($userPassword);
$users[41][0] = "USR043"; $users[41][1] = "Andrea"; $users[41][2] = md5($userPassword);
$users[42][0] = "USR044"; $users[42][1] = "Brooke"; $users[42][2] = md5($userPassword);
$users[43][0] = "USR045"; $users[43][1] = "Julian"; $users[43][2] = md5($userPassword);
$users[44][0] = "USR046"; $users[44][1] = "Christian"; $users[44][2] = md5($userPassword);
$users[45][0] = "USR047"; $users[45][1] = "Patrick"; $users[45][2] = md5($userPassword);
$users[46][0] = "USR048"; $users[46][1] = "Sydney"; $users[46][2] = md5($userPassword);
$users[47][0] = "USR049"; $users[47][1] = "Chelsea"; $users[47][2] = md5($userPassword);
$users[48][0] = "USR050"; $users[48][1] = "Victoria"; $users[48][2] = md5($userPassword);
$users[49][0] = "USR051"; $users[49][1] = "Charles"; $users[49][2] = md5($userPassword);
$users[50][0] = "USR052"; $users[50][1] = "Jayden"; $users[50][2] = md5($userPassword);
$users[51][0] = "USR053"; $users[51][1] = "Caroline"; $users[51][2] = md5($userPassword);
$users[52][0] = "USR054"; $users[52][1] = "Ashlyn"; $users[52][2] = md5($userPassword);
$users[53][0] = "USR055"; $users[53][1] = "Colin"; $users[53][2] = md5($userPassword);
$users[54][0] = "USR056"; $users[54][1] = "Blake"; $users[54][2] = md5($userPassword);
$users[55][0] = "USR057"; $users[55][1] = "Haley"; $users[55][2] = md5($userPassword);
$users[56][0] = "USR058"; $users[56][1] = "Katherine"; $users[56][2] = md5($userPassword);
$users[57][0] = "USR059"; $users[57][1] = "Charlotte"; $users[57][2] = md5($userPassword);
$users[58][0] = "USR060"; $users[58][1] = "George"; $users[58][2] = md5($userPassword);
$users[59][0] = "USR061"; $users[59][1] = "Richard"; $users[59][2] = md5($userPassword);
$users[60][0] = "USR062"; $users[60][1] = "Heather"; $users[60][2] = md5($userPassword);
$users[61][0] = "USR063"; $users[61][1] = "Oliver"; $users[61][2] = md5($userPassword);
$users[62][0] = "USR064"; $users[62][1] = "Alexandra"; $users[62][2] = md5($userPassword);
$users[63][0] = "USR065"; $users[63][1] = "Courtney"; $users[63][2] = md5($userPassword);
$users[64][0] = "USR066"; $users[64][1] = "Ellie"; $users[64][2] = md5($userPassword);
$users[65][0] = "USR067"; $users[65][1] = "Skyler"; $users[65][2] = md5($userPassword);
$users[66][0] = "USR068"; $users[66][1] = "Mariah"; $users[66][2] = md5($userPassword);
$users[67][0] = "USR069"; $users[67][1] = "Scott"; $users[67][2] = md5($userPassword);
$users[68][0] = "USR070"; $users[68][1] = "Isabel"; $users[68][2] = md5($userPassword);
$users[69][0] = "USR071"; $users[69][1] = "Christina"; $users[69][2] = md5($userPassword);
$users[70][0] = "USR072"; $users[70][1] = "Jamie"; $users[70][2] = md5($userPassword);
$users[71][0] = "USR073"; $users[71][1] = "Edward"; $users[71][2] = md5($userPassword);
$users[72][0] = "USR074"; $users[72][1] = "Stephen"; $users[72][2] = md5($userPassword);
$users[73][0] = "USR075"; $users[73][1] = "Karen"; $users[73][2] = md5($userPassword);
$users[74][0] = "USR076"; $users[74][1] = "Parker"; $users[74][2] = md5($userPassword);
$users[75][0] = "USR077"; $users[75][1] = "Jeremy"; $users[75][2] = md5($userPassword);
$users[76][0] = "USR078"; $users[76][1] = "Peter"; $users[76][2] = md5($userPassword);
$users[77][0] = "USR079"; $users[77][1] = "Lindsey"; $users[77][2] = md5($userPassword);
$users[78][0] = "USR080"; $users[78][1] = "Henry"; $users[78][2] = md5($userPassword);
$users[79][0] = "USR081"; $users[79][1] = "Alice"; $users[79][2] = md5($userPassword);
$users[80][0] = "USR082"; $users[80][1] = "Sandra"; $users[80][2] = md5($userPassword);
$users[81][0] = "USR083"; $users[81][1] = "Travis"; $users[81][2] = md5($userPassword);
$users[82][0] = "USR084"; $users[82][1] = "Colton"; $users[82][2] = md5($userPassword);
$users[83][0] = "USR085"; $users[83][1] = "Brian"; $users[83][2] = md5($userPassword);
$users[84][0] = "USR086"; $users[84][1] = "Daisy"; $users[84][2] = md5($userPassword);
$users[85][0] = "USR087"; $users[85][1] = "Barbara"; $users[85][2] = md5($userPassword);
$users[86][0] = "USR088"; $users[86][1] = "Jeffrey"; $users[86][2] = md5($userPassword);
$users[87][0] = "USR089"; $users[87][1] = "Eliza"; $users[87][2] = md5($userPassword);
$users[88][0] = "USR090"; $users[88][1] = "Helena"; $users[88][2] = md5($userPassword);
$users[89][0] = "USR091"; $users[89][1] = "Linda"; $users[89][2] = md5($userPassword);
$users[90][0] = "USR092"; $users[90][1] = "Lilly"; $users[90][2] = md5($userPassword);
$users[91][0] = "USR093"; $users[91][1] = "Gregory"; $users[91][2] = md5($userPassword);
$users[92][0] = "USR094"; $users[92][1] = "Harry"; $users[92][2] = md5($userPassword);
$users[93][0] = "USR095"; $users[93][1] = "Nancy"; $users[93][2] = md5($userPassword);
$users[94][0] = "USR096"; $users[94][1] = "Harrison"; $users[94][2] = md5($userPassword);
$users[95][0] = "USR097"; $users[95][1] = "Monica"; $users[95][2] = md5($userPassword);
$users[96][0] = "USR098"; $users[96][1] = "Martin"; $users[96][2] = md5($userPassword);
$users[97][0] = "USR099"; $users[97][1] = "Cindy"; $users[97][2] = md5($userPassword);
$users[98][0] = "USR100"; $users[98][1] = "Violet"; $users[98][2] = md5($userPassword);
$users[99][0] = "USR101"; $users[99][1] = "Vivian"; $users[99][2] = md5($userPassword);
$users[100][0] = "USR102"; $users[100][1] = "Dennis"; $users[100][2] = md5($userPassword);
$users[101][0] = "USR103"; $users[101][1] = "Maggie"; $users[101][2] = md5($userPassword);
$users[102][0] = "USR104"; $users[102][1] = "Justine"; $users[102][2] = md5($userPassword);
$users[103][0] = "USR105"; $users[103][1] = "Ronald"; $users[103][2] = md5($userPassword);
$users[104][0] = "USR106"; $users[104][1] = "Lawrence"; $users[104][2] = md5($userPassword);
$users[105][0] = "USR107"; $users[105][1] = "Elvis"; $users[105][2] = md5($userPassword);
$users[106][0] = "USR108"; $users[106][1] = "Bruce"; $users[106][2] = md5($userPassword);
$users[107][0] = "USR109"; $users[107][1] = "Melinda"; $users[107][2] = md5($userPassword);
$users[108][0] = "USR110"; $users[108][1] = "Phillip"; $users[108][2] = md5($userPassword);
$users[109][0] = "USR111"; $users[109][1] = "Janet"; $users[109][2] = md5($userPassword);
...
EMPSQLSTR;
    ...
    if ($i == 0) {
        // Default admin - use environment variable for password
        $adminPassword = getenv('ADMIN_PASSWORD') ?: 'admin';
        $adminPasswordHash = md5($adminPassword);
        $q = "INSERT INTO `ohrm_user` ( `emp_number`, `user_name`, `user_password`,`user_role_id`) VALUES ('1', 'admin', '$adminPasswordHash', 1)";
        $runQuery($q);
    }
